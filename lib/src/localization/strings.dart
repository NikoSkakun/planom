...
const Map<String, String> _en = {
  ...
  'tabBar': 'Tab Bar', 'sectionLanguage': 'Language', 'language': 'Language',
  'sectionData': 'Data',
...
const Map<String, String> _uk = {
  ...
  'tabBar': 'Панель вкладок', 'sectionLanguage': 'Мова', 'language': 'Мова',
  'sectionData': 'Дані',
...
const Map<String, String> _es = {
  ...
  'tabBar': 'Barra de pestañas', 'sectionLanguage': 'Idioma', 'language': 'Idioma',
  'sectionData': 'Datos',
...
const Map<String, String> _fr = {
  ...
  'tabBar': 'Barre d’onglets', 'sectionLanguage': 'Langue', 'language': 'Langue',
  'sectionData': 'Données',
...
const Map<String, String> _de = {
  ...
  'tabBar': 'Tab-Leiste', 'sectionLanguage': 'Sprache', 'language': 'Sprache',
  'sectionData': 'Daten',
...
const Map<String, String> _it = {
  ...
  'tabBar': 'Barra schede', 'sectionLanguage': 'Lingua', 'language': 'Lingua',
  'sectionData': 'Dati',
...
const Map<String, String> _pt = {
  ...
  'tabBar': 'Barra de abas', 'sectionLanguage': 'Idioma', 'language': 'Idioma',
  'sectionData': 'Dados',
...
const Map<String, String> _ru = {
  ...
  'tabBar': 'Панель вкладок', 'sectionLanguage': 'Язык', 'language': 'Язык',
  'sectionData': 'Данные',
...
const Map<String, String> _zh = {
  ...
  'tabBar': '标签栏', 'sectionLanguage': '语言', 'language': '语言',
  'sectionData': '数据',
...
const Map<String, String> _ja = {
  ...
  'tabBar': 'タブバー', 'sectionLanguage': '言語', 'language': '言語',
  'sectionData': 'データ',
