...
const Map<String, String> _uk = {
  ...
  'tabBarPagesHint': 'Додавайте більше сторінок, щоб умістити понад 5 вкладок. Гортайте панель вкладок по горизонталі для перемикання між сторінками.',
...
const Map<String, String> _es = {
  ...
  'tabBarPagesHint': 'Añade más páginas para tener más de 5 pestañas. Desliza horizontalmente en la barra para cambiar de página.',
...
const Map<String, String> _fr = {
  ...
  'tabBarPagesHint': 'Ajoutez des pages pour dépasser 5 onglets. Balayez horizontalement sur la barre d\'onglets pour changer de page.',
...
const Map<String, String> _de = {
  ...
  'tabBarPagesHint': 'Füge weitere Seiten hinzu, um mehr als 5 Tabs unterzubringen. Wische horizontal über die Tableiste, um zwischen Seiten zu wechseln.',
...
const Map<String, String> _it = {
  ...
  'tabBarPagesHint': 'Aggiungi altre pagine per più di 5 schede. Scorri orizzontalmente sulla barra delle schede per passare da una pagina all\'altra.',
...
const Map<String, String> _pt = {
  ...
  'tabBarPagesHint': 'Adicione mais páginas para ter mais de 5 abas. Deslize horizontalmente na barra de abas para alternar entre as páginas.',
...
const Map<String, String> _ru = {
  ...
  'tabBarPagesHint': 'Добавьте страницы, чтобы разместить больше 5 вкладок. Проводите по панели вкладок по горизонтали для переключения страниц.',
...
const Map<String, String> _zh = {
  ...
  'tabBarPages': '标签栏页面',
  'tabBarPagesHint': '添加更多页面以容纳超过 5 个标签。在标签栏上左右滑动可切换页面。',
  'addPage': '添加页面',
...
const Map<String, String> _ja = {
  ...
  'tabBarPagesHint': 'ページを追加すると 5 つを超えるタブを配置できます。タブバーを横にスワイプしてページを切り替えます。',
  'addPage': 'ページを追加',
