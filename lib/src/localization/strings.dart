...
class S {
  ...
  String get specificWeek => t('specificWeek');
  String get specificMonth => t('specificMonth');
  String get routineMonthDaysPrefix => t('routineMonthDaysPrefix');
  String get continueAfterCompletion => t('continueAfterCompletion');
  String get continueAfterCompletionInfo => t('continueAfterCompletionInfo');
  ...
  // ── Finance ───────────────────────────────────────────────────────────────
  String get tabFinance => t('tabFinance');
  String get more => t('more');
  String get transactions => t('transactions');
  String get newTransaction => t('newTransaction');
  String get editTransaction => t('editTransaction');
  String get transactionTitle => t('transactionTitle');
  String get expense => t('expense');
  String get expenses => t('expenses');
  String get income => t('income');
  String get spent => t('spent');
  String get balance => t('balance');
  String get category => t('category');
  String get categories => t('categories');
  String get uncategorized => t('uncategorized');
  String get newCategory => t('newCategory');
  String get editCategory => t('editCategory');
  String get categoryName => t('categoryName');
  String get noCategoriesYet => t('noCategoriesYet');
  String get deleteCategoryTitle => t('deleteCategoryTitle');
  String get deleteCategoryBody => t('deleteCategoryBody');
  String get deleteTransactionTitle => t('deleteTransactionTitle');
  String get deleteTransactionBody => t('deleteTransactionBody');
  String get transactionDeleted => t('transactionDeleted');
  String get noTransactionsThisMonth => t('noTransactionsThisMonth');
  String get tapPlusToAddTransaction => t('tapPlusToAddTransaction');
  String get spendingByCategory => t('spendingByCategory');
  String get budgets => t('budgets');
  String get budgetsHint => t('budgetsHint');
  String get budgetAmountHint => t('budgetAmountHint');
  String get budgetPeriod => t('budgetPeriod');
  String get monthly => t('monthly');
  String get weekly => t('weekly');
  String get noBudget => t('noBudget');
  String get overallBudget => t('overallBudget');
  String get weeklyBudget => t('weeklyBudget');
  String get sectionCurrency => t('sectionCurrency');
  String get currency => t('currency');
  String get customCurrency => t('customCurrency');
  String get showDecimals => t('showDecimals');
  String get showDecimalsHint => t('showDecimalsHint');
  String get colorLabel => t('colorLabel');
  String get iconLabel => t('iconLabel');

  // ── Goals ─────────────────────────────────────────────────────────────────
  String get tabGoals => t('tabGoals');
  String get goalNew => t('goalNew');
  String get goalEdit => t('goalEdit');
  String get goalName => t('goalName');
  String get goalDescription => t('goalDescription');
  String get goalSources => t('goalSources');
  String get goalNoSourcesHint => t('goalNoSourcesHint');
  String get goalAddSource => t('goalAddSource');
  String get goalEditSource => t('goalEditSource');
  String get goalSourceKind => t('goalSourceKind');
  String get goalSourcePicked => t('goalSourcePicked');
  String get goalSourcePickedHint => t('goalSourcePickedHint');
  String get goalSourceRule => t('goalSourceRule');
  String get goalSourceRuleHint => t('goalSourceRuleHint');
  String get goalScope => t('goalScope');
  String get goalScopeAll => t('goalScopeAll');
  String get goalScopeFolders => t('goalScopeFolders');
  String get goalScopeLists => t('goalScopeLists');
  String get goalScopeSections => t('goalScopeSections');
  String get goalScopeNothingSelected => t('goalScopeNothingSelected');
  String get goalScopeNothingToPick => t('goalScopeNothingToPick');
  String get goalFilters => t('goalFilters');
  String get goalFilterAny => t('goalFilterAny');
  String get goalDateFilter => t('goalDateFilter');
  String get goalDateAny => t('goalDateAny');
  String get goalDateNone => t('goalDateNone');
  String get goalDateOverdue => t('goalDateOverdue');
  String get goalDateThisWeek => t('goalDateThisWeek');
  String get goalDateThisMonth => t('goalDateThisMonth');
  String get goalDateRange => t('goalDateRange');
  String get goalRangeFrom => t('goalRangeFrom');
  String get goalRangeTo => t('goalRangeTo');
  String get goalPickTasks => t('goalPickTasks');
  String get goalNoTasksToPick => t('goalNoTasksToPick');
  String get goalTrackedTasks => t('goalTrackedTasks');
  String get goalNoTasksYet => t('goalNoTasksYet');
  String get goalNoGoalsYet => t('goalNoGoalsYet');
  String get goalTapPlusToCreate => t('goalTapPlusToCreate');
  String get goalDeleted => t('goalDeleted');
  String get goalDeleteTitle => t('goalDeleteTitle');
  String get goalDeleteBody => t('goalDeleteBody');
  String get goalMissing => t('goalMissing');
  String get goalsModuleHint => t('goalsModuleHint');
  String get tabBarSwipe => t('tabBarSwipe');
  String get tabBarSwipeMode => t('tabBarSwipeMode');
  String get tabBarSwipePages => t('tabBarSwipePages');
  String get tabBarSwipeSpaces => t('tabBarSwipeSpaces');
  String get tabBarSwipePagesHint => t('tabBarSwipePagesHint');
  String get tabBarSwipeSpacesHint => t('tabBarSwipeSpacesHint');
  String get notesMarkdownAlwaysHint => t('notesMarkdownAlwaysHint');
  String get accounts => t('accounts');
  String get account => t('account');
  String get allAccounts => t('allAccounts');
  String get noAccount => t('noAccount');
  String get newAccount => t('newAccount');
  String get editAccount => t('editAccount');
  String get accountName => t('accountName');
  String get accountType => t('accountType');
  String get accountTypeCash => t('accountTypeCash');
  String get accountTypeCard => t('accountTypeCard');
  String get accountTypeBank => t('accountTypeBank');
  String get accountTypeSavings => t('accountTypeSavings');
  String get accountTypeOther => t('accountTypeOther');
  String get accountInitialBalance => t('accountInitialBalance');
  String get accountInitialBalanceHint => t('accountInitialBalanceHint');
  String get accountArchive => t('accountArchive');
  String get accountUnarchive => t('accountUnarchive');
  String get accountArchived => t('accountArchived');
  String get showArchivedAccounts => t('showArchivedAccounts');
  String get accountsTotal => t('accountsTotal');
  String get noAccountsYet => t('noAccountsYet');
  ...
  String get transferFrom => t('transferFrom');
  String get transferTo => t('transferTo');
  String get transferPickAccount => t('transferPickAccount');
  String get transferReceivedAmount => t('transferReceivedAmount');
  ...
  String leftToSpend(String amount) =>
      t('leftToSpend').replaceAll('{amount}', amount);
  String overBudgetBy(String amount) =>
      t('overBudgetBy').replaceAll('{amount}', amount);
  String goalTasksSelected(int n) =>
      t('goalTasksSelected').replaceAll('{n}', '\$n');
  String goalMatchesTasks(int n) =>
      t('goalMatchesTasks').replaceAll('{n}', '\$n');
  String goalMatchesShort(int n) =>
      t('goalMatchesShort').replaceAll('{n}', '\$n');
  String goalProgressCount(int done, int total) => t('goalProgressCount')
      .replaceAll('{done}', '\$done')
      .replaceAll('{total}', '\$total');
  String budgetsCurrencyHint(String currency) =>
      t('budgetsCurrencyHint').replaceAll('{currency}', currency);
...
const Map<String, String> _en = {
  // ── Goals / tab-bar swipe / markdown notes / finance accounts ───────
  'tabGoals': 'Goals',
  'goalNew': 'New Goal',
  'goalEdit': 'Edit Goal',
  'goalName': 'Goal name',
  'goalDescription': 'Description (optional)',
  'goalSources': 'What it tracks',
  'goalNoSourcesHint': 'Add tasks, folders or a filter — a goal tracks everything its sources match.',
  'goalAddSource': 'Add source',
  'goalEditSource': 'Edit source',
  'goalSourceKind': 'Source',
  'goalSourcePicked': 'Picked tasks',
  'goalSourcePickedHint': 'A fixed set of tasks you choose by hand.',
  'goalSourceRule': 'Rule',
  'goalSourceRuleHint': 'Everything in a scope, optionally filtered. Tasks added later join in automatically.',
  'goalScope': 'Scope',
  'goalScopeAll': 'All tasks',
  'goalScopeFolders': 'Folders',
  'goalScopeLists': 'Lists',
  'goalScopeSections': 'Sections',
  'goalScopeNothingSelected': 'Nothing selected',
  'goalScopeNothingToPick': 'Nothing to pick here yet.',
  'goalFilters': 'Filters',
  'goalFilterAny': 'Any',
  'goalDateFilter': 'Due date',
  'goalDateAny': 'Any',
  'goalDateNone': 'No date',
  'goalDateOverdue': 'Due before today',
  'goalDateThisWeek': 'This week',
  'goalDateThisMonth': 'This month',
  'goalDateRange': 'Date range',
  'goalRangeFrom': 'From',
  'goalRangeTo': 'To',
  'goalPickTasks': 'Pick tasks',
  'goalNoTasksToPick': 'No tasks to pick yet.',
  'goalTasksSelected': '{n} selected',
  'goalMatchesTasks': 'Matches {n} tasks right now',
  'goalMatchesShort': '{n} tasks',
  'goalTrackedTasks': 'Tracked tasks',
  'goalNoTasksYet': 'No tasks tracked yet',
  'goalProgressCount': '{done} of {total} done',
  'goalNoGoalsYet': 'No goals yet',
  'goalTapPlusToCreate': 'Tap + to create one',
  'goalDeleted': 'Goal deleted',
  'goalDeleteTitle': 'Delete goal?',
  'goalDeleteBody': 'The goal is removed. Its tasks are untouched.',
  'goalMissing': 'This goal no longer exists.',
  'goalsModuleHint': 'A goal tracks a collection of tasks — picked by hand, by folder or list, or by a filter — and shows how much of it is done.',
  'tabBarSwipe': 'Swipe',
  'tabBarSwipeMode': 'Swiping the bar',
  'tabBarSwipePages': 'Tab pages',
  'tabBarSwipeSpaces': 'Spaces',
  'tabBarSwipePagesHint': 'Swipe the tab bar to move between pages of tabs.',
  'tabBarSwipeSpacesHint': 'Swipe the tab bar to switch Space. Only the first page of tabs is shown.',
  'notesMarkdownAlwaysHint': 'Notes are written in Markdown — CommonMark plus GitHub extensions (tables, task lists, footnotes) and LaTeX between \$ … \$ or \$\$ … \$\$.',
  'accounts': 'Accounts',
  'account': 'Account',
  'allAccounts': 'All',
  ...
  'accountInitialBalance': 'Starting balance',
  'accountInitialBalanceHint': 'What the account held before you started tracking it.',
  'accountArchive': 'Archive',
  'accountUnarchive': 'Unarchive',
  'accountArchived': 'Archived',
  'showArchivedAccounts': 'Show archived',
  'accountsTotal': 'Total',
  'noAccountsYet': 'No accounts yet',
  'deleteAccountTitle': 'Delete account?',
  'deleteAccountBody': 'Entries stay, but lose their account.',
  'manage': 'Manage',
  'transfer': 'Transfer',
  'transferFrom': 'From',
  'transferTo': 'To',
  'transferPickAccount': 'Pick account',
  'transferReceivedAmount': 'Amount received',
  'budgetsCurrencyHint': 'Budgets count entries in {currency} only — the app never converts between currencies.',
  // ── Finance ──────────────────────────────────────────────────────────
  'tabFinance': 'Finance',
  'more': 'More',
  ...
  'deleteCategoryBody': 'Entries stay, but become uncategorized.',
  'deleteTransactionTitle': 'Delete entry?',
  'deleteTransactionBody': 'This entry will be removed permanently.',
  'transactionDeleted': 'Entry deleted',
  'noTransactionsThisMonth': 'Nothing recorded this month',
  'tapPlusToAddTransaction': 'Tap + to add an expense or income',
  'spendingByCategory': 'Spending by category',
  'budgets': 'Budgets',
  'budgetsHint': 'Set an allowance for total spending or for a single category. Progress appears on the Finance tab.',
  'budgetAmountHint': 'Enter an amount, or clear it to remove the budget.',
  ...
  'leftToSpend': '{amount} left',
  'overBudgetBy': '{amount} over',
  'sectionCurrency': 'Currency',
  'currency': 'Currency symbol',
  'customCurrency': 'Custom…',
  'showDecimals': 'Show decimals',
  'showDecimalsHint': 'Turn off for currencies counted in whole units.',
  'colorLabel': 'Color',
  'iconLabel': 'Icon',
  'appTitle': 'planom',
  ...
  'specificWeek': 'Week', 'specificMonth': 'Month', 'routineMonthDaysPrefix': 'Days',
  'continueAfterCompletion': 'Continue tracking after completion',
  'continueAfterCompletionInfo': 'Keep recording progress after the goal is reached',
...
const Map<String, String> _uk = {
  ...
  'tabGoals': 'Цілі',
  'goalNew': 'Нова ціль',
  'goalEdit': 'Редагувати ціль',
  'goalName': 'Назва цілі',
  'goalDescription': 'Опис (необов’язково)',
  'goalSources': 'Що відстежується',
  'goalNoSourcesHint': 'Додайте завдання, папки або фільтр — ціль відстежує все, що підпадає під її джерела.',
  'goalAddSource': 'Додати джерело',
  'goalEditSource': 'Редагувати джерело',
  'goalSourceKind': 'Джерело',
  'goalSourcePicked': 'Обрані завдання',
  'goalSourcePickedHint': 'Фіксований набір завдань, які ви обрали вручну.',
  'goalSourceRule': 'Правило',
  'goalSourceRuleHint': 'Усе в межах області, за потреби з фільтрами. Нові завдання додаються автоматично.',
  'goalScope': 'Область',
  'goalScopeAll': 'Усі завдання',
  'goalScopeFolders': 'Папки',
  'goalScopeLists': 'Списки',
  'goalScopeSections': 'Розділи',
  'goalScopeNothingSelected': 'Нічого не обрано',
  'goalScopeNothingToPick': 'Тут поки немає з чого обирати.',
  'goalFilters': 'Фільтри',
  'goalFilterAny': 'Будь-який',
  'goalDateFilter': 'Термін',
  'goalDateAny': 'Будь-який',
  'goalDateNone': 'Без дати',
  'goalDateOverdue': 'Термін до сьогодні',
  'goalDateThisWeek': 'Цього тижня',
  'goalDateThisMonth': 'Цього місяця',
  'goalDateRange': 'Діапазон дат',
  'goalRangeFrom': 'Від',
  'goalRangeTo': 'До',
  'goalPickTasks': 'Обрати завдання',
  'goalNoTasksToPick': 'Поки немає завдань для вибору.',
  'goalTasksSelected': 'Обрано: {n}',
  'goalMatchesTasks': 'Зараз підпадає завдань: {n}',
  'goalMatchesShort': '{n} завд.',
  'goalTrackedTasks': 'Відстежувані завдання',
  'goalNoTasksYet': 'Ще немає відстежуваних завдань',
  'goalProgressCount': 'Виконано {done} з {total}',
  'goalNoGoalsYet': 'Цілей ще немає',
  'goalTapPlusToCreate': 'Натисніть +, щоб створити',
  'goalDeleted': 'Ціль видалено',
  'goalDeleteTitle': 'Видалити ціль?',
  'goalDeleteBody': 'Ціль буде видалено. Завдання залишаться недоторканими.',
  'goalMissing': 'Цієї цілі більше не існує.',
  'goalsModuleHint': 'Ціль відстежує набір завдань — обраних вручну, за папкою чи списком, або за фільтром — і показує, наскільки він виконаний.',
  'tabBarSwipe': 'Гортання',
  'tabBarSwipeMode': 'Гортання панелі',
  'tabBarSwipePages': 'Сторінки вкладок',
  'tabBarSwipeSpaces': 'Простори',
  'tabBarSwipePagesHint': 'Гортайте панель вкладок, щоб перемикати сторінки вкладок.',
  'tabBarSwipeSpacesHint': 'Гортайте панель вкладок, щоб перемикати Простір. Показується лише перша сторінка вкладок.',
  'notesMarkdownAlwaysHint': 'Нотатки пишуться в Markdown — CommonMark разом із розширеннями GitHub (таблиці, списки задач, виноски) та LaTeX між \$ … \$ або \$\$ … \$\$.',
  'accounts': 'Рахунки',
  'account': 'Рахунок',
  'allAccounts': 'Усі',
  'noAccount': 'Без рахунку',
  'newAccount': 'Новий рахунок',
  'editAccount': 'Редагувати рахунок',
  'accountName': 'Назва рахунку',
  'accountType': 'Тип',
  'accountTypeCash': 'Готівка',
  'accountTypeCard': 'Картка',
  'accountTypeBank': 'Банк',
  'accountTypeSavings': 'Заощадження',
  'accountTypeOther': 'Інше',
  'accountInitialBalance': 'Початковий баланс',
  'accountInitialBalanceHint': 'Скільки було на рахунку до початку обліку.',
  'accountArchive': 'Архівувати',
  'accountUnarchive': 'Розархівувати',
  'accountArchived': 'В архіві',
  'showArchivedAccounts': 'Показати архівні',
  'accountsTotal': 'Разом',
  'noAccountsYet': 'Рахунків ще немає',
  'deleteAccountTitle': 'Видалити рахунок?',
  'deleteAccountBody': 'Записи залишаться, але без рахунку.',
  'manage': 'Керувати',
  'transfer': 'Переказ',
  'transferFrom': 'З',
  'transferTo': 'На',
  'transferPickAccount': 'Оберіть рахунок',
  'transferReceivedAmount': 'Отримана сума',
  'budgetsCurrencyHint': 'Бюджети враховують лише записи в {currency} — застосунок не конвертує валюти.',
  // ── Finance ──────────────────────────────────────────────────────────
  'tabFinance': 'Фінанси',
  'more': 'Ще',
  'transactions': 'Операції',
  'newTransaction': 'Новий запис',
  'editTransaction': 'Редагувати запис',
  'transactionTitle': 'Опис',
  'expense': 'Витрата',
  'expenses': 'Витрати',
  'income': 'Дохід',
  'spent': 'Витрачено',
  ...
  'deleteCategoryBody': 'Записи залишаться, але стануть без категорії.',
  'deleteTransactionTitle': 'Видалити запис?',
  'deleteTransactionBody': 'Цей запис буде видалено назавжди.',
  'transactionDeleted': 'Запис видалено',
  'noTransactionsThisMonth': 'Цього місяця записів немає',
  'tapPlusToAddTransaction': 'Натисніть +, щоб додати витрату або дохід',
  'spendingByCategory': 'Витрати за категоріями',
  'budgets': 'Бюджети',
  'budgetsHint': 'Встановіть ліміт для всіх витрат або для окремої категорії. Прогрес показується на вкладці «Фінанси».',
  'budgetAmountHint': 'Введіть суму або очистіть, щоб прибрати бюджет.',
  'budgetPeriod': 'Період бюджету',
  'monthly': 'Щомісяця',
  'weekly': 'Щотижня',
  'noBudget': 'Немає',
  'overallBudget': 'Загальний бюджет',
  'weeklyBudget': 'Тижневий бюджет',
  'leftToSpend': 'Залишилось {amount}',
  'overBudgetBy': 'Перевищення на {amount}',
  'sectionCurrency': 'Валюта',
  'currency': 'Символ валюти',
  'customCurrency': 'Власний…',
  'showDecimals': 'Показувати копійки',
  'showDecimalsHint': 'Вимкніть для валют без дробової частини.',
  'colorLabel': 'Колір',
  'iconLabel': 'Іконка',
  ...
  'specificWeek': 'Тиждень', 'specificMonth': 'Місяць', 'routineMonthDaysPrefix': 'Дні',
  'continueAfterCompletion': 'Продовжувати після виконання',
  'continueAfterCompletionInfo': 'Записувати прогрес навіть після досягнення мети',
...
const Map<String, String> _es = {
  // ── Goals / tab-bar swipe / markdown notes / finance accounts ───────
  'tabGoals': 'Objetivos',
  'goalNew': 'Nuevo objetivo',
  'goalEdit': 'Editar objetivo',
  'goalName': 'Nombre del objetivo',
  'goalDescription': 'Descripción (opcional)',
  'goalSources': 'Qué incluye',
  'goalNoSourcesHint': 'Añade tareas, carpetas o un filtro: el objetivo sigue todo lo que coincida con sus fuentes.',
  'goalAddSource': 'Añadir fuente',
  'goalEditSource': 'Editar fuente',
  'goalSourceKind': 'Fuente',
  'goalSourcePicked': 'Tareas elegidas',
  'goalSourcePickedHint': 'Un conjunto fijo de tareas elegidas a mano.',
  'goalSourceRule': 'Regla',
  'goalSourceRuleHint': 'Todo dentro de un ámbito, con filtros opcionales. Las tareas nuevas se añaden solas.',
  'goalScope': 'Ámbito',
  'goalScopeAll': 'Todas las tareas',
  'goalScopeFolders': 'Carpetas',
  'goalScopeLists': 'Listas',
  'goalScopeSections': 'Secciones',
  'goalScopeNothingSelected': 'Nada seleccionado',
  'goalScopeNothingToPick': 'Aquí todavía no hay nada que elegir.',
  'goalFilters': 'Filtros',
  'goalFilterAny': 'Cualquiera',
  'goalDateFilter': 'Fecha',
  'goalDateAny': 'Cualquiera',
  'goalDateNone': 'Sin fecha',
  'goalDateOverdue': 'Vence antes de hoy',
  'goalDateThisWeek': 'Esta semana',
  'goalDateThisMonth': 'Este mes',
  'goalDateRange': 'Intervalo de fechas',
  'goalRangeFrom': 'Desde',
  'goalRangeTo': 'Hasta',
  'goalPickTasks': 'Elegir tareas',
  'goalNoTasksToPick': 'Todavía no hay tareas que elegir.',
  'goalTasksSelected': '{n} seleccionadas',
  'goalMatchesTasks': 'Ahora coinciden {n} tareas',
  'goalMatchesShort': '{n} tareas',
  'goalTrackedTasks': 'Tareas seguidas',
  'goalNoTasksYet': 'Todavía no sigue ninguna tarea',
  'goalProgressCount': '{done} de {total} hechas',
  'goalNoGoalsYet': 'Aún no hay objetivos',
  'goalTapPlusToCreate': 'Toca + para crear uno',
  'goalDeleted': 'Objetivo eliminado',
  'goalDeleteTitle': '¿Eliminar objetivo?',
  'goalDeleteBody': 'Se elimina el objetivo. Sus tareas no se tocan.',
  'goalMissing': 'Este objetivo ya no existe.',
  'goalsModuleHint': 'Un objetivo sigue un conjunto de tareas — elegidas a mano, por carpeta o lista, o por filtro — y muestra cuánto se ha completado.',
  'tabBarSwipe': 'Deslizar',
  'tabBarSwipeMode': 'Al deslizar la barra',
  'tabBarSwipePages': 'Páginas de pestañas',
  'tabBarSwipeSpaces': 'Espacios',
  'tabBarSwipePagesHint': 'Desliza la barra de pestañas para cambiar de página.',
  'tabBarSwipeSpacesHint': 'Desliza la barra de pestañas para cambiar de Espacio. Solo se muestra la primera página.',
  'notesMarkdownAlwaysHint': 'Las notas se escriben en Markdown: CommonMark más las extensiones de GitHub (tablas, listas de tareas, notas al pie) y LaTeX entre \$ … \$ o \$\$ … \$\$.',
  'accounts': 'Cuentas',
  'account': 'Cuenta',
  'allAccounts': 'Todas',
  ...
  'accountInitialBalanceHint': 'Lo que había en la cuenta antes de empezar a registrarla.',
  'accountArchive': 'Archivar',
  'accountUnarchive': 'Desarchivar',
  'accountArchived': 'Archivada',
  'showArchivedAccounts': 'Mostrar archivadas',
  'accountsTotal': 'Total',
  'noAccountsYet': 'Aún no hay cuentas',
  'deleteAccountTitle': '¿Eliminar cuenta?',
  'deleteAccountBody': 'Los movimientos se mantienen, pero se quedan sin cuenta.',
  'manage': 'Gestionar',
  'transfer': 'Transferencia',
  'transferFrom': 'De',
  'transferTo': 'A',
  'transferPickAccount': 'Elegir cuenta',
  'transferReceivedAmount': 'Importe recibido',
  'budgetsCurrencyHint': 'Los presupuestos solo cuentan movimientos en {currency}: la app nunca convierte entre monedas.',
  // ── Finance ──────────────────────────────────────────────────────────
  'tabFinance': 'Finanzas',
  'more': 'Más',
  ...
  'deleteCategoryBody': 'Los movimientos se mantienen, pero quedan sin categoría.',
  'deleteTransactionTitle': '¿Eliminar movimiento?',
  'deleteTransactionBody': 'Este movimiento se eliminará permanentemente.',
  'transactionDeleted': 'Movimiento eliminado',
  'noTransactionsThisMonth': 'No hay movimientos este mes',
  'tapPlusToAddTransaction': 'Toca + para añadir un gasto o un ingreso',
  'spendingByCategory': 'Gastos por categoría',
  'budgets': 'Presupuestos',
  'budgetsHint': 'Define un límite para el gasto total o para una categoría. El progreso aparece en la pestaña Finanzas.',
  'budgetAmountHint': 'Introduce un importe o bórralo para quitar el presupuesto.',
  'budgetPeriod': 'Periodo del presupuesto',
  'monthly': 'Mensual',
  'weekly': 'Semanal',
  'noBudget': 'Ninguno',
  'overallBudget': 'Presupuesto total',
  'weeklyBudget': 'Presupuesto semanal',
  'leftToSpend': 'Quedan {amount}',
  'overBudgetBy': '{amount} de más',
  'sectionCurrency': 'Moneda',
  'currency': 'Símbolo de moneda',
  'customCurrency': 'Personalizado…',
  'showDecimals': 'Mostrar decimales',
  'showDecimalsHint': 'Desactívalo para monedas sin decimales.',
  'colorLabel': 'Color',
  'iconLabel': 'Icono',
  ...
  'specificWeek': 'Semana', 'specificMonth': 'Mes', 'routineMonthDaysPrefix': 'Días',
  'continueAfterCompletion': 'Seguir registrando tras completar',
  'continueAfterCompletionInfo': 'Sigue registrando el progreso después de alcanzar la meta',
...
const Map<String, String> _fr = {
  ...
  'goalDescription': 'Description (facultatif)',
  'goalSources': 'Contenu suivi',
  'goalNoSourcesHint': 'Ajoutez des tâches, des dossiers ou un filtre : l\'objectif suit tout ce qui correspond à ses sources.',
  'goalAddSource': 'Ajouter une source',
  'goalEditSource': 'Modifier la source',
  'goalSourceKind': 'Source',
  'goalSourcePicked': 'Tâches choisies',
  'goalSourcePickedHint': 'Un ensemble fixe de tâches choisies à la main.',
  'goalSourceRule': 'Règle',
  'goalSourceRuleHint': 'Tout ce qui est dans une portée, avec filtres facultatifs. Les nouvelles tâches s\'ajoutent automatiquement.',
  'goalScope': 'Portée',
  'goalScopeAll': 'Toutes les tâches',
  'goalScopeFolders': 'Dossiers',
  'goalScopeLists': 'Listes',
  'goalScopeSections': 'Sections',
  'goalScopeNothingSelected': 'Rien de sélectionné',
  'goalScopeNothingToPick': 'Rien à choisir ici pour l\'instant.',
  'goalFilters': 'Filtres',
  'goalFilterAny': 'Indifférent',
  'goalDateFilter': 'Échéance',
  'goalDateAny': 'Indifférent',
  'goalDateNone': 'Sans date',
  'goalDateOverdue': 'Échéance avant aujourd\'hui',
  'goalDateThisWeek': 'Cette semaine',
  'goalDateThisMonth': 'Ce mois-ci',
  'goalDateRange': 'Plage de dates',
  'goalRangeFrom': 'Du',
  'goalRangeTo': 'Au',
  'goalPickTasks': 'Choisir des tâches',
  'goalNoTasksToPick': 'Aucune tâche à choisir pour l\'instant.',
  'goalTasksSelected': '{n} sélectionnées',
  'goalMatchesTasks': 'Correspond à {n} tâches actuellement',
  'goalMatchesShort': '{n} tâches',
  'goalTrackedTasks': 'Tâches suivies',
  'goalNoTasksYet': 'Aucune tâche suivie',
  'goalProgressCount': '{done} sur {total} faites',
  'goalNoGoalsYet': 'Aucun objectif',
  'goalTapPlusToCreate': 'Touchez + pour en créer un',
  'goalDeleted': 'Objectif supprimé',
  'goalDeleteTitle': 'Supprimer l\'objectif ?',
  'goalDeleteBody': 'L\'objectif est supprimé. Ses tâches restent intactes.',
  'goalMissing': 'Cet objectif n\'existe plus.',
  'goalsModuleHint': 'Un objectif suit un ensemble de tâches — choisies à la main, par dossier ou liste, ou par filtre — et montre son avancement.',
  'tabBarSwipe': 'Balayage',
  'tabBarSwipeMode': 'Balayage de la barre',
  'tabBarSwipePages': 'Pages d\'onglets',
  'tabBarSwipeSpaces': 'Espaces',
  'tabBarSwipePagesHint': 'Balayez la barre d\'onglets pour changer de page.',
  'tabBarSwipeSpacesHint': 'Balayez la barre d\'onglets pour changer d\'Espace. Seule la première page d\'onglets est affichée.',
  'notesMarkdownAlwaysHint': 'Les notes s\'écrivent en Markdown : CommonMark plus les extensions GitHub (tableaux, listes de tâches, notes de bas de page) et LaTeX entre \$ … \$ ou \$\$ … \$\$.',
  'accounts': 'Comptes',
  'account': 'Compte',
  'allAccounts': 'Tous',
  ...
  'accountInitialBalance': 'Solde initial',
  'accountInitialBalanceHint': 'Ce que contenait le compte avant le suivi.',
  'accountArchive': 'Archiver',
  'accountUnarchive': 'Désarchiver',
  'accountArchived': 'Archivé',
  'showArchivedAccounts': 'Afficher les archivés',
  'accountsTotal': 'Total',
  'noAccountsYet': 'Aucun compte',
  'deleteAccountTitle': 'Supprimer le compte ?',
  'deleteAccountBody': 'Les opérations sont conservées, mais sans compte.',
  'manage': 'Gérer',
  'transfer': 'Virement',
  'transferFrom': 'De',
  'transferTo': 'Vers',
  'transferPickAccount': 'Choisir un compte',
  'transferReceivedAmount': 'Montant reçu',
  'budgetsCurrencyHint': 'Les budgets ne comptent que les opérations en {currency} — l\'app ne convertit jamais les devises.',
  // ── Finance ──────────────────────────────────────────────────────────
  'tabFinance': 'Finances',
  'more': 'Plus',
  ...
  'deleteCategoryBody': 'Les opérations sont conservées, mais sans catégorie.',
  'deleteTransactionTitle': 'Supprimer l\'opération ?',
  'deleteTransactionBody': 'Cette opération sera définitivement supprimée.',
  'transactionDeleted': 'Opération supprimée',
  'noTransactionsThisMonth': 'Aucune opération ce mois-ci',
  'tapPlusToAddTransaction': 'Touchez + pour ajouter une dépense ou un revenu',
  'spendingByCategory': 'Dépenses par catégorie',
  'budgets': 'Budgets',
  'budgetsHint': 'Définissez un plafond pour les dépenses totales ou pour une catégorie. La progression apparaît dans l\'onglet Finances.',
  'budgetAmountHint': 'Saisissez un montant, ou effacez-le pour retirer le budget.',
  'budgetPeriod': 'Période du budget',
  'monthly': 'Mensuel',
  'weekly': 'Hebdomadaire',
  'noBudget': 'Aucun',
  'overallBudget': 'Budget global',
  'weeklyBudget': 'Budget hebdomadaire',
  'leftToSpend': '{amount} restants',
  'overBudgetBy': '{amount} de dépassement',
  'sectionCurrency': 'Devise',
  'currency': 'Symbole monétaire',
  'customCurrency': 'Personnalisé…',
  'showDecimals': 'Afficher les décimales',
  'showDecimalsHint': 'Désactivez pour les devises sans décimales.',
  'colorLabel': 'Couleur',
  'iconLabel': 'Icône',
  ...
  'specificWeek': 'Semaine', 'specificMonth': 'Mois', 'routineMonthDaysPrefix': 'Jours',
  'continueAfterCompletion': 'Continuer le suivi après l\'achèvement',
  'continueAfterCompletionInfo': 'Continuer à enregistrer la progression après avoir atteint l\'objectif',
...
const Map<String, String> _de = {
  ...
  'goalDescription': 'Beschreibung (optional)',
  'goalSources': 'Was verfolgt wird',
  'goalNoSourcesHint': 'Füge Aufgaben, Ordner oder einen Filter hinzu — das Ziel verfolgt alles, was zu seinen Quellen passt.',
  'goalAddSource': 'Quelle hinzufügen',
  'goalEditSource': 'Quelle bearbeiten',
  'goalSourceKind': 'Quelle',
  'goalSourcePicked': 'Ausgewählte Aufgaben',
  'goalSourcePickedHint': 'Eine feste Auswahl von Hand gewählter Aufgaben.',
  'goalSourceRule': 'Regel',
  'goalSourceRuleHint': 'Alles in einem Bereich, optional gefiltert. Später erstellte Aufgaben kommen automatisch dazu.',
  'goalScope': 'Bereich',
  'goalScopeAll': 'Alle Aufgaben',
  'goalScopeFolders': 'Ordner',
  'goalScopeLists': 'Listen',
  'goalScopeSections': 'Abschnitte',
  'goalScopeNothingSelected': 'Nichts ausgewählt',
  'goalScopeNothingToPick': 'Hier gibt es noch nichts zur Auswahl.',
  'goalFilters': 'Filter',
  'goalFilterAny': 'Beliebig',
  'goalDateFilter': 'Fälligkeit',
  'goalDateAny': 'Beliebig',
  'goalDateNone': 'Ohne Datum',
  'goalDateOverdue': 'Fällig vor heute',
  'goalDateThisWeek': 'Diese Woche',
  'goalDateThisMonth': 'Diesen Monat',
  'goalDateRange': 'Zeitraum',
  'goalRangeFrom': 'Von',
  'goalRangeTo': 'Bis',
  'goalPickTasks': 'Aufgaben wählen',
  'goalNoTasksToPick': 'Noch keine Aufgaben zur Auswahl.',
  'goalTasksSelected': '{n} ausgewählt',
  'goalMatchesTasks': 'Trifft aktuell auf {n} Aufgaben zu',
  'goalMatchesShort': '{n} Aufgaben',
  'goalTrackedTasks': 'Verfolgte Aufgaben',
  'goalNoTasksYet': 'Noch keine Aufgaben verfolgt',
  'goalProgressCount': '{done} von {total} erledigt',
  'goalNoGoalsYet': 'Noch keine Ziele',
  'goalTapPlusToCreate': 'Tippe auf +, um eines zu erstellen',
  'goalDeleted': 'Ziel gelöscht',
  'goalDeleteTitle': 'Ziel löschen?',
  'goalDeleteBody': 'Das Ziel wird entfernt. Die Aufgaben bleiben unberührt.',
  'goalMissing': 'Dieses Ziel existiert nicht mehr.',
  'goalsModuleHint': 'Ein Ziel verfolgt eine Sammlung von Aufgaben — von Hand gewählt, per Ordner oder Liste, oder per Filter — und zeigt den Fortschritt.',
  'tabBarSwipe': 'Wischen',
  'tabBarSwipeMode': 'Wischen auf der Leiste',
  'tabBarSwipePages': 'Tab-Seiten',
  'tabBarSwipeSpaces': 'Bereiche',
  'tabBarSwipePagesHint': 'Wische über die Tab-Leiste, um zwischen Tab-Seiten zu wechseln.',
  'tabBarSwipeSpacesHint': 'Wische über die Tab-Leiste, um den Bereich zu wechseln. Es wird nur die erste Tab-Seite gezeigt.',
  'notesMarkdownAlwaysHint': 'Notizen werden in Markdown geschrieben — CommonMark plus GitHub-Erweiterungen (Tabellen, Aufgabenlisten, Fußnoten) und LaTeX zwischen \$ … \$ oder \$\$ … \$\$.',
  'accounts': 'Konten',
  'account': 'Konto',
  'allAccounts': 'Alle',
  ...
  'accountTypeBank': 'Bank',
  'accountTypeSavings': 'Sparen',
  'accountTypeOther': 'Sonstiges',
  'accountInitialBalance': 'Anfangssaldo',
  'accountInitialBalanceHint': 'Was auf dem Konto war, bevor du es erfasst hast.',
  'accountArchive': 'Archivieren',
  'accountUnarchive': 'Aus Archiv holen',
  'accountArchived': 'Archiviert',
  'showArchivedAccounts': 'Archivierte anzeigen',
  'accountsTotal': 'Gesamt',
  'noAccountsYet': 'Noch keine Konten',
  'deleteAccountTitle': 'Konto löschen?',
  'deleteAccountBody': 'Buchungen bleiben erhalten, verlieren aber ihr Konto.',
  'manage': 'Verwalten',
  'transfer': 'Umbuchung',
  'transferFrom': 'Von',
  'transferTo': 'Nach',
  'transferPickAccount': 'Konto wählen',
  'transferReceivedAmount': 'Erhaltener Betrag',
  'budgetsCurrencyHint': 'Budgets zählen nur Buchungen in {currency} — die App rechnet Währungen nie um.',
  // ── Finance ──────────────────────────────────────────────────────────
  'tabFinance': 'Finanzen',
  'more': 'Mehr',
  ...
  'deleteCategoryBody': 'Buchungen bleiben erhalten, aber ohne Kategorie.',
  'deleteTransactionTitle': 'Buchung löschen?',
  'deleteTransactionBody': 'Diese Buchung wird endgültig gelöscht.',
  'transactionDeleted': 'Buchung gelöscht',
  'noTransactionsThisMonth': 'In diesem Monat nichts erfasst',
  'tapPlusToAddTransaction': 'Tippe auf +, um eine Ausgabe oder Einnahme hinzuzufügen',
  'spendingByCategory': 'Ausgaben nach Kategorie',
  'budgets': 'Budgets',
  'budgetsHint': 'Lege ein Limit für die Gesamtausgaben oder eine Kategorie fest. Der Fortschritt erscheint im Tab „Finanzen“.',
  'budgetAmountHint': 'Betrag eingeben oder löschen, um das Budget zu entfernen.',
  'budgetPeriod': 'Budgetzeitraum',
  'monthly': 'Monatlich',
  'weekly': 'Wöchentlich',
  'noBudget': 'Keins',
  'overallBudget': 'Gesamtbudget',
  'weeklyBudget': 'Wochenbudget',
  'leftToSpend': '{amount} übrig',
  'overBudgetBy': '{amount} über Budget',
  'sectionCurrency': 'Währung',
  'currency': 'Währungssymbol',
  'customCurrency': 'Eigenes…',
  'showDecimals': 'Nachkommastellen anzeigen',
  'showDecimalsHint': 'Für Währungen ohne Nachkommastellen ausschalten.',
  'colorLabel': 'Farbe',
  'iconLabel': 'Symbol',
  ...
  'specificWeek': 'Woche', 'specificMonth': 'Monat', 'routineMonthDaysPrefix': 'Tage',
  'continueAfterCompletion': 'Nach Abschluss weiter erfassen',
  'continueAfterCompletionInfo': 'Fortschritt auch nach Erreichen des Ziels weiter erfassen',
...
const Map<String, String> _it = {
  // ── Goals / tab-bar swipe / markdown notes / finance accounts ───────
  'tabGoals': 'Obiettivi',
  'goalNew': 'Nuovo obiettivo',
  'goalEdit': 'Modifica obiettivo',
  'goalName': 'Nome dell\'obiettivo',
  'goalDescription': 'Descrizione (facoltativa)',
  'goalSources': 'Cosa segue',
  'goalNoSourcesHint': 'Aggiungi attività, cartelle o un filtro: l\'obiettivo segue tutto ciò che corrisponde alle sue fonti.',
  'goalAddSource': 'Aggiungi fonte',
  'goalEditSource': 'Modifica fonte',
  'goalSourceKind': 'Fonte',
  'goalSourcePicked': 'Attività scelte',
  'goalSourcePickedHint': 'Un insieme fisso di attività scelte a mano.',
  'goalSourceRule': 'Regola',
  'goalSourceRuleHint': 'Tutto dentro un ambito, con filtri facoltativi. Le nuove attività si aggiungono da sole.',
  'goalScope': 'Ambito',
  'goalScopeAll': 'Tutte le attività',
  'goalScopeFolders': 'Cartelle',
  'goalScopeLists': 'Elenchi',
  'goalScopeSections': 'Sezioni',
  'goalScopeNothingSelected': 'Niente selezionato',
  'goalScopeNothingToPick': 'Qui non c\'è ancora nulla da scegliere.',
  'goalFilters': 'Filtri',
  'goalFilterAny': 'Qualsiasi',
  'goalDateFilter': 'Scadenza',
  'goalDateAny': 'Qualsiasi',
  'goalDateNone': 'Senza data',
  'goalDateOverdue': 'Scadenza prima di oggi',
  'goalDateThisWeek': 'Questa settimana',
  'goalDateThisMonth': 'Questo mese',
  'goalDateRange': 'Intervallo di date',
  'goalRangeFrom': 'Dal',
  'goalRangeTo': 'Al',
  'goalPickTasks': 'Scegli attività',
  'goalNoTasksToPick': 'Nessuna attività da scegliere.',
  'goalTasksSelected': '{n} selezionate',
  'goalMatchesTasks': 'Ora corrispondono {n} attività',
  'goalMatchesShort': '{n} attività',
  'goalTrackedTasks': 'Attività seguite',
  'goalNoTasksYet': 'Nessuna attività seguita',
  'goalProgressCount': '{done} di {total} completate',
  'goalNoGoalsYet': 'Ancora nessun obiettivo',
  'goalTapPlusToCreate': 'Tocca + per crearne uno',
  'goalDeleted': 'Obiettivo eliminato',
  'goalDeleteTitle': 'Eliminare l\'obiettivo?',
  'goalDeleteBody': 'L\'obiettivo viene rimosso. Le sue attività restano intatte.',
  'goalMissing': 'Questo obiettivo non esiste più.',
  'goalsModuleHint': 'Un obiettivo segue un insieme di attività — scelte a mano, per cartella o elenco, o per filtro — e mostra quanto è stato completato.',
  'tabBarSwipe': 'Scorrimento',
  'tabBarSwipeMode': 'Scorrendo la barra',
  'tabBarSwipePages': 'Pagine di schede',
  'tabBarSwipeSpaces': 'Spazi',
  'tabBarSwipePagesHint': 'Scorri la barra delle schede per cambiare pagina.',
  'tabBarSwipeSpacesHint': 'Scorri la barra delle schede per cambiare Spazio. Viene mostrata solo la prima pagina.',
  'notesMarkdownAlwaysHint': 'Le note si scrivono in Markdown: CommonMark più le estensioni GitHub (tabelle, elenchi di attività, note a piè di pagina) e LaTeX tra \$ … \$ o \$\$ … \$\$.',
  'accounts': 'Conti',
  'account': 'Conto',
  'allAccounts': 'Tutti',
  ...
  'accountTypeCard': 'Carta',
  'accountTypeBank': 'Banca',
  'accountTypeSavings': 'Risparmi',
  'accountTypeOther': 'Altro',
  'accountInitialBalance': 'Saldo iniziale',
  'accountInitialBalanceHint': 'Quanto c\'era sul conto prima di iniziare a tracciarlo.',
  'accountArchive': 'Archivia',
  'accountUnarchive': 'Ripristina',
  'accountArchived': 'Archiviato',
  'showArchivedAccounts': 'Mostra archiviati',
  'accountsTotal': 'Totale',
  'noAccountsYet': 'Ancora nessun conto',
  'deleteAccountTitle': 'Eliminare il conto?',
  'deleteAccountBody': 'I movimenti restano, ma senza conto.',
  'manage': 'Gestisci',
  'transfer': 'Trasferimento',
  'transferFrom': 'Da',
  'transferTo': 'A',
  'transferPickAccount': 'Scegli un conto',
  'transferReceivedAmount': 'Importo ricevuto',
  'budgetsCurrencyHint': 'I budget contano solo i movimenti in {currency}: l\'app non converte mai tra valute.',
  // ── Finance ──────────────────────────────────────────────────────────
  'tabFinance': 'Finanze',
  'more': 'Altro',
  ...
  'deleteCategoryBody': 'I movimenti restano, ma senza categoria.',
  'deleteTransactionTitle': 'Eliminare il movimento?',
  'deleteTransactionBody': 'Questo movimento sarà eliminato definitivamente.',
  'transactionDeleted': 'Movimento eliminato',
  'noTransactionsThisMonth': 'Nessun movimento questo mese',
  'tapPlusToAddTransaction': 'Tocca + per aggiungere una spesa o un\'entrata',
  'spendingByCategory': 'Spese per categoria',
  'budgets': 'Budget',
  'budgetsHint': 'Imposta un limite per la spesa totale o per una categoria. Il progresso appare nella scheda Finanze.',
  'budgetAmountHint': 'Inserisci un importo oppure cancellalo per rimuovere il budget.',
  'budgetPeriod': 'Periodo del budget',
  'monthly': 'Mensile',
  'weekly': 'Settimanale',
  'noBudget': 'Nessuno',
  'overallBudget': 'Budget totale',
  'weeklyBudget': 'Budget settimanale',
  'leftToSpend': '{amount} rimasti',
  'overBudgetBy': '{amount} oltre il budget',
  'sectionCurrency': 'Valuta',
  'currency': 'Simbolo della valuta',
  'customCurrency': 'Personalizzato…',
  'showDecimals': 'Mostra i decimali',
  'showDecimalsHint': 'Disattiva per le valute senza decimali.',
  'colorLabel': 'Colore',
  'iconLabel': 'Icona',
  ...
  'specificWeek': 'Settimana', 'specificMonth': 'Mese', 'routineMonthDaysPrefix': 'Giorni',
  'continueAfterCompletion': 'Continua a registrare dopo il completamento',
  'continueAfterCompletionInfo': 'Continua a registrare i progressi dopo aver raggiunto l\'obiettivo',
...
const Map<String, String> _pt = {
  ...
  'tabGoals': 'Metas',
  'goalNew': 'Nova meta',
  'goalEdit': 'Editar meta',
  'goalName': 'Nome da meta',
  'goalDescription': 'Descrição (opcional)',
  'goalSources': 'O que acompanha',
  'goalNoSourcesHint': 'Adicione tarefas, pastas ou um filtro — a meta acompanha tudo o que combina com suas fontes.',
  'goalAddSource': 'Adicionar fonte',
  'goalEditSource': 'Editar fonte',
  'goalSourceKind': 'Fonte',
  'goalSourcePicked': 'Tarefas escolhidas',
  'goalSourcePickedHint': 'Um conjunto fixo de tarefas escolhidas à mão.',
  'goalSourceRule': 'Regra',
  'goalSourceRuleHint': 'Tudo dentro de um escopo, com filtros opcionais. Tarefas novas entram sozinhas.',
  'goalScope': 'Escopo',
  'goalScopeAll': 'Todas as tarefas',
  'goalScopeFolders': 'Pastas',
  'goalScopeLists': 'Listas',
  'goalScopeSections': 'Seções',
  'goalScopeNothingSelected': 'Nada selecionado',
  'goalScopeNothingToPick': 'Ainda não há nada para escolher aqui.',
  'goalFilters': 'Filtros',
  'goalFilterAny': 'Qualquer',
  'goalDateFilter': 'Prazo',
  'goalDateAny': 'Qualquer',
  'goalDateNone': 'Sem data',
  'goalDateOverdue': 'Vence antes de hoje',
  'goalDateThisWeek': 'Esta semana',
  'goalDateThisMonth': 'Este mês',
  'goalDateRange': 'Intervalo de datas',
  'goalRangeFrom': 'De',
  'goalRangeTo': 'Até',
  'goalPickTasks': 'Escolher tarefas',
  'goalNoTasksToPick': 'Ainda não há tarefas para escolher.',
  'goalTasksSelected': '{n} selecionadas',
  'goalMatchesTasks': 'Corresponde a {n} tarefas agora',
  'goalMatchesShort': '{n} tarefas',
  'goalTrackedTasks': 'Tarefas acompanhadas',
  'goalNoTasksYet': 'Nenhuma tarefa acompanhada ainda',
  'goalProgressCount': '{done} de {total} concluídas',
  'goalNoGoalsYet': 'Ainda não há metas',
  'goalTapPlusToCreate': 'Toque em + para criar uma',
  'goalDeleted': 'Meta excluída',
  'goalDeleteTitle': 'Excluir meta?',
  'goalDeleteBody': 'A meta é removida. As tarefas ficam intactas.',
  'goalMissing': 'Esta meta não existe mais.',
  'goalsModuleHint': 'Uma meta acompanha um conjunto de tarefas — escolhidas à mão, por pasta ou lista, ou por filtro — e mostra o quanto já foi feito.',
  'tabBarSwipe': 'Deslizar',
  'tabBarSwipeMode': 'Ao deslizar a barra',
  'tabBarSwipePages': 'Páginas de abas',
  'tabBarSwipeSpaces': 'Espaços',
  'tabBarSwipePagesHint': 'Deslize a barra de abas para mudar de página.',
  'tabBarSwipeSpacesHint': 'Deslize a barra de abas para trocar de Espaço. Só a primeira página de abas aparece.',
  'notesMarkdownAlwaysHint': 'As notas são escritas em Markdown — CommonMark mais as extensões do GitHub (tabelas, listas de tarefas, notas de rodapé) e LaTeX entre \$ … \$ ou \$\$ … \$\$.',
  'accounts': 'Contas',
  'account': 'Conta',
  'allAccounts': 'Todas',
  'noAccount': 'Sem conta',
  ...
  'accountTypeCard': 'Cartão',
  'accountTypeBank': 'Banco',
  'accountTypeSavings': 'Poupança',
  'accountTypeOther': 'Outro',
  'accountInitialBalance': 'Saldo inicial',
  'accountInitialBalanceHint': 'O que a conta tinha antes de você começar a registrar.',
  'accountArchive': 'Arquivar',
  'accountUnarchive': 'Desarquivar',
  'accountArchived': 'Arquivada',
  'showArchivedAccounts': 'Mostrar arquivadas',
  'accountsTotal': 'Total',
  'noAccountsYet': 'Ainda não há contas',
  'deleteAccountTitle': 'Excluir conta?',
  'deleteAccountBody': 'Os lançamentos permanecem, mas ficam sem conta.',
  'manage': 'Gerenciar',
  'transfer': 'Transferência',
  'transferFrom': 'De',
  'transferTo': 'Para',
  'transferPickAccount': 'Escolher conta',
  'transferReceivedAmount': 'Valor recebido',
  'budgetsCurrencyHint': 'Orçamentos contam apenas lançamentos em {currency} — o app nunca converte entre moedas.',
  // ── Finance ──────────────────────────────────────────────────────────
  'tabFinance': 'Finanças',
  'more': 'Mais',
  ...
  'deleteCategoryBody': 'Os lançamentos permanecem, mas ficam sem categoria.',
  'deleteTransactionTitle': 'Excluir lançamento?',
  'deleteTransactionBody': 'Este lançamento será excluído permanentemente.',
  'transactionDeleted': 'Lançamento excluído',
  'noTransactionsThisMonth': 'Nada registrado neste mês',
  'tapPlusToAddTransaction': 'Toque em + para adicionar uma despesa ou receita',
  'spendingByCategory': 'Gastos por categoria',
  'budgets': 'Orçamentos',
  'budgetsHint': 'Defina um limite para o gasto total ou para uma categoria. O progresso aparece na aba Finanças.',
  'budgetAmountHint': 'Digite um valor ou limpe para remover o orçamento.',
  'budgetPeriod': 'Período do orçamento',
  'monthly': 'Mensal',
  'weekly': 'Semanal',
  'noBudget': 'Nenhum',
  'overallBudget': 'Orçamento total',
  'weeklyBudget': 'Orçamento semanal',
  'leftToSpend': 'Restam {amount}',
  'overBudgetBy': '{amount} acima',
  'sectionCurrency': 'Moeda',
  'currency': 'Símbolo da moeda',
  'customCurrency': 'Personalizado…',
  'showDecimals': 'Mostrar decimais',
  'showDecimalsHint': 'Desative para moedas sem casas decimais.',
  'colorLabel': 'Cor',
  'iconLabel': 'Ícone',
  ...
  'specificWeek': 'Semana', 'specificMonth': 'Mês', 'routineMonthDaysPrefix': 'Dias',
  'continueAfterCompletion': 'Continuar a registar após concluir',
  'continueAfterCompletionInfo': 'Continue a registar o progresso depois de atingir a meta',
...
const Map<String, String> _ru = {
  ...
  'tabGoals': 'Цели',
  'goalNew': 'Новая цель',
  'goalEdit': 'Изменить цель',
  'goalName': 'Название цели',
  'goalDescription': 'Описание (необязательно)',
  'goalSources': 'Что отслеживается',
  'goalNoSourcesHint': 'Добавьте задачи, папки или фильтр — цель отслеживает всё, что подходит под её источники.',
  'goalAddSource': 'Добавить источник',
  'goalEditSource': 'Изменить источник',
  'goalSourceKind': 'Источник',
  'goalSourcePicked': 'Выбранные задачи',
  'goalSourcePickedHint': 'Фиксированный набор задач, выбранных вручную.',
  'goalSourceRule': 'Правило',
  'goalSourceRuleHint': 'Всё в пределах области, при желании с фильтрами. Новые задачи добавляются сами.',
  'goalScope': 'Область',
  'goalScopeAll': 'Все задачи',
  'goalScopeFolders': 'Папки',
  'goalScopeLists': 'Списки',
  'goalScopeSections': 'Разделы',
  'goalScopeNothingSelected': 'Ничего не выбрано',
  'goalScopeNothingToPick': 'Здесь пока нечего выбрать.',
  'goalFilters': 'Фильтры',
  'goalFilterAny': 'Любой',
  'goalDateFilter': 'Срок',
  'goalDateAny': 'Любой',
  'goalDateNone': 'Без даты',
  'goalDateOverdue': 'Срок до сегодня',
  'goalDateThisWeek': 'На этой неделе',
  'goalDateThisMonth': 'В этом месяце',
  'goalDateRange': 'Диапазон дат',
  'goalRangeFrom': 'С',
  'goalRangeTo': 'По',
  'goalPickTasks': 'Выбрать задачи',
  'goalNoTasksToPick': 'Пока нет задач для выбора.',
  'goalTasksSelected': 'Выбрано: {n}',
  'goalMatchesTasks': 'Сейчас подходит задач: {n}',
  'goalMatchesShort': '{n} задач',
  'goalTrackedTasks': 'Отслеживаемые задачи',
  'goalNoTasksYet': 'Пока нет отслеживаемых задач',
  'goalProgressCount': 'Выполнено {done} из {total}',
  'goalNoGoalsYet': 'Целей пока нет',
  'goalTapPlusToCreate': 'Нажмите +, чтобы создать',
  'goalDeleted': 'Цель удалена',
  'goalDeleteTitle': 'Удалить цель?',
  'goalDeleteBody': 'Цель будет удалена. Задачи останутся нетронутыми.',
  'goalMissing': 'Этой цели больше не существует.',
  'goalsModuleHint': 'Цель отслеживает набор задач — выбранных вручную, по папке или списку, либо по фильтру — и показывает, сколько уже сделано.',
  'tabBarSwipe': 'Свайп',
  'tabBarSwipeMode': 'Свайп по панели',
  'tabBarSwipePages': 'Страницы вкладок',
  'tabBarSwipeSpaces': 'Пространства',
  'tabBarSwipePagesHint': 'Проведите по панели вкладок, чтобы менять страницы вкладок.',
  'tabBarSwipeSpacesHint': 'Проведите по панели вкладок, чтобы сменить Пространство. Показывается только первая страница вкладок.',
  'notesMarkdownAlwaysHint': 'Заметки пишутся в Markdown — CommonMark плюс расширения GitHub (таблицы, списки задач, сноски) и LaTeX между \$ … \$ или \$\$ … \$\$.',
  'accounts': 'Счета',
  'account': 'Счёт',
  'allAccounts': 'Все',
  'noAccount': 'Без счёта',
  ...
  'accountInitialBalance': 'Начальный баланс',
  'accountInitialBalanceHint': 'Сколько было на счёте до начала учёта.',
  'accountArchive': 'В архив',
  'accountUnarchive': 'Из архива',
  'accountArchived': 'В архиве',
  'showArchivedAccounts': 'Показать архивные',
  'accountsTotal': 'Итого',
  'noAccountsYet': 'Счетов пока нет',
  'deleteAccountTitle': 'Удалить счёт?',
  'deleteAccountBody': 'Записи останутся, но без счёта.',
  'manage': 'Управление',
  'transfer': 'Перевод',
  'transferFrom': 'Со счёта',
  'transferTo': 'На счёт',
  'transferPickAccount': 'Выберите счёт',
  'transferReceivedAmount': 'Полученная сумма',
  'budgetsCurrencyHint': 'Бюджеты учитывают только записи в {currency} — приложение не конвертирует валюты.',
  // ── Finance ──────────────────────────────────────────────────────────
  'tabFinance': 'Финансы',
  'more': 'Ещё',
  'transactions': 'Операции',
  'newTransaction': 'Новая запись',
  'editTransaction': 'Изменить запись',
  'transactionTitle': 'Описание',
  'expense': 'Расход',
  'expenses': 'Расходы',
  'income': 'Доходы',
  'spent': 'Потрачено',
  ...
  'deleteCategoryBody': 'Записи останутся, но станут без категории.',
  'deleteTransactionTitle': 'Удалить запись?',
  'deleteTransactionBody': 'Эта запись будет удалена навсегда.',
  'transactionDeleted': 'Запись удалена',
  'noTransactionsThisMonth': 'В этом месяце ничего не записано',
  'tapPlusToAddTransaction': 'Нажмите +, чтобы добавить расход или доход',
  'spendingByCategory': 'Расходы по категориям',
  'budgets': 'Бюджеты',
  'budgetsHint': 'Задайте лимит для всех расходов или для отдельной категории. Прогресс отображается на вкладке «Финансы».',
  'budgetAmountHint': 'Введите сумму или очистите, чтобы убрать бюджет.',
  ...
  'leftToSpend': 'Осталось {amount}',
  'overBudgetBy': 'Превышение на {amount}',
  'sectionCurrency': 'Валюта',
  'currency': 'Символ валюты',
  'customCurrency': 'Свой…',
  'showDecimals': 'Показывать копейки',
  'showDecimalsHint': 'Отключите для валют без дробной части.',
  'colorLabel': 'Цвет',
  'iconLabel': 'Значок',
  ...
  'specificWeek': 'Неделя', 'specificMonth': 'Месяц', 'routineMonthDaysPrefix': 'Дни',
  'continueAfterCompletion': 'Продолжать отслеживать после выполнения',
  'continueAfterCompletionInfo': 'Записывать прогресс даже после достижения цели',
...
const Map<String, String> _zh = {
  ...
  'goalSources': '跟踪内容',
  'goalNoSourcesHint': '添加任务、文件夹或筛选条件——目标会跟踪所有符合其来源的任务。',
  'goalAddSource': '添加来源',
  'goalEditSource': '编辑来源',
  'goalSourceKind': '来源',
  'goalSourcePicked': '选定的任务',
  'goalSourcePickedHint': '手动挑选的一组固定任务。',
  'goalSourceRule': '规则',
  'goalSourceRuleHint': '某个范围内的全部任务，可加筛选。之后新建的任务会自动加入。',
  'goalScope': '范围',
  'goalScopeAll': '全部任务',
  'goalScopeFolders': '文件夹',
  'goalScopeLists': '列表',
  'goalScopeSections': '分区',
  'goalScopeNothingSelected': '未选择',
  'goalScopeNothingToPick': '这里暂时没有可选项。',
  'goalFilters': '筛选',
  'goalFilterAny': '不限',
  'goalDateFilter': '截止日期',
  'goalDateAny': '不限',
  'goalDateNone': '无日期',
  'goalDateOverdue': '今天之前到期',
  'goalDateThisWeek': '本周',
  'goalDateThisMonth': '本月',
  'goalDateRange': '日期区间',
  'goalRangeFrom': '从',
  'goalRangeTo': '到',
  'goalPickTasks': '选择任务',
  'goalNoTasksToPick': '暂无可选任务。',
  'goalTasksSelected': '已选 {n} 项',
  'goalMatchesTasks': '当前匹配 {n} 个任务',
  'goalMatchesShort': '{n} 个任务',
  'goalTrackedTasks': '跟踪的任务',
  'goalNoTasksYet': '尚未跟踪任何任务',
  'goalProgressCount': '已完成 {done} / {total}',
  'goalNoGoalsYet': '暂无目标',
  'goalTapPlusToCreate': '点按 + 新建',
  'goalDeleted': '目标已删除',
  'goalDeleteTitle': '删除目标？',
  'goalDeleteBody': '目标会被删除，其中的任务不受影响。',
  'goalMissing': '该目标已不存在。',
  'goalsModuleHint': '目标用来跟踪一组任务——手动挑选、按文件夹或列表、或按筛选条件——并显示完成进度。',
  'tabBarSwipe': '滑动',
  'tabBarSwipeMode': '滑动标签栏时',
  'tabBarSwipePages': '标签页',
  'tabBarSwipeSpaces': '空间',
  'tabBarSwipePagesHint': '滑动标签栏在多页标签之间切换。',
  'tabBarSwipeSpacesHint': '滑动标签栏切换空间，仅显示第一页标签。',
  'notesMarkdownAlwaysHint': '笔记使用 Markdown 书写——CommonMark 加 GitHub 扩展（表格、任务列表、脚注），以及位于 \$ … \$ 或 \$\$ … \$\$ 之间的 LaTeX。',
  'accounts': '账户',
  'account': '账户',
  'allAccounts': '全部',
  'noAccount': '无账户',
  ...
  'accountTypeOther': '其他',
  'accountInitialBalance': '初始余额',
  'accountInitialBalanceHint': '开始记账之前账户里的金额。',
  'accountArchive': '归档',
  'accountUnarchive': '取消归档',
  'accountArchived': '已归档',
  'showArchivedAccounts': '显示已归档',
  'accountsTotal': '合计',
  'noAccountsYet': '暂无账户',
  'deleteAccountTitle': '删除账户？',
  'deleteAccountBody': '记录会保留，但不再关联账户。',
  'manage': '管理',
  'transfer': '转账',
  'transferFrom': '从',
  'transferTo': '到',
  'transferPickAccount': '选择账户',
  'transferReceivedAmount': '到账金额',
  'budgetsCurrencyHint': '预算仅统计以 {currency} 计价的记录——应用不会在货币之间换算。',
  // ── Finance ──────────────────────────────────────────────────────────
  'tabFinance': '财务',
  'more': '更多',
  'transactions': '交易',
  ...
  'deleteCategoryBody': '记录会保留，但将变为未分类。',
  'deleteTransactionTitle': '删除记录？',
  'deleteTransactionBody': '此记录将被永久删除。',
  'transactionDeleted': '记录已删除',
  'noTransactionsThisMonth': '本月暂无记录',
  'tapPlusToAddTransaction': '点按 + 添加支出或收入',
  'spendingByCategory': '各分类支出',
  'budgets': '预算',
  'budgetsHint': '为总支出或单个分类设置额度，进度会显示在“财务”标签页。',
  'budgetAmountHint': '输入金额，或清除以移除预算。',
  'budgetPeriod': '预算周期',
  'monthly': '每月',
  'weekly': '每周',
  'noBudget': '无',
  'overallBudget': '总预算',
  'weeklyBudget': '每周预算',
  'leftToSpend': '剩余 {amount}',
  'overBudgetBy': '超出 {amount}',
  'sectionCurrency': '货币',
  'currency': '货币符号',
  'customCurrency': '自定义…',
  'showDecimals': '显示小数',
  'showDecimalsHint': '对于不使用小数的货币可关闭。',
  'colorLabel': '颜色',
  'iconLabel': '图标',
  'sectionAdvanced': '高级',
  'splitScreen': '分屏',
  ...
  'specificWeek': '按周', 'specificMonth': '按月', 'routineMonthDaysPrefix': '每月',
  'continueAfterCompletion': '完成后继续记录',
  'continueAfterCompletionInfo': '达成目标后仍可继续记录进度',
...
const Map<String, String> _ja = {
  ...
  'goalSources': '追跡する対象',
  'goalNoSourcesHint': 'タスク・フォルダ・フィルタを追加します。ゴールはソースに一致するものをすべて追跡します。',
  'goalAddSource': 'ソースを追加',
  'goalEditSource': 'ソースを編集',
  'goalSourceKind': 'ソース',
  'goalSourcePicked': '選んだタスク',
  'goalSourcePickedHint': '手動で選んだ固定のタスク群。',
  'goalSourceRule': 'ルール',
  'goalSourceRuleHint': '範囲内のすべて（任意でフィルタ）。後から作ったタスクも自動で加わります。',
  'goalScope': '範囲',
  'goalScopeAll': 'すべてのタスク',
  'goalScopeFolders': 'フォルダ',
  'goalScopeLists': 'リスト',
  'goalScopeSections': 'セクション',
  'goalScopeNothingSelected': '未選択',
  'goalScopeNothingToPick': 'ここにはまだ選べるものがありません。',
  'goalFilters': 'フィルタ',
  'goalFilterAny': '指定なし',
  'goalDateFilter': '期限',
  'goalDateAny': '指定なし',
  'goalDateNone': '日付なし',
  'goalDateOverdue': '今日より前が期限',
  'goalDateThisWeek': '今週',
  'goalDateThisMonth': '今月',
  'goalDateRange': '期間',
  'goalRangeFrom': '開始',
  'goalRangeTo': '終了',
  'goalPickTasks': 'タスクを選ぶ',
  'goalNoTasksToPick': '選べるタスクがまだありません。',
  'goalTasksSelected': '{n} 件選択中',
  'goalMatchesTasks': '現在 {n} 件のタスクが一致',
  'goalMatchesShort': '{n} 件',
  'goalTrackedTasks': '追跡中のタスク',
  'goalNoTasksYet': '追跡中のタスクはありません',
  'goalProgressCount': '{total} 件中 {done} 件完了',
  'goalNoGoalsYet': 'ゴールがありません',
  'goalTapPlusToCreate': '+ をタップして作成',
  'goalDeleted': 'ゴールを削除しました',
  'goalDeleteTitle': 'ゴールを削除しますか？',
  'goalDeleteBody': 'ゴールは削除されますが、タスクはそのまま残ります。',
  'goalMissing': 'このゴールは存在しません。',
  'goalsModuleHint': 'ゴールはタスクの集まり（手動選択・フォルダやリスト・フィルタ）を追跡し、達成度を表示します。',
  'tabBarSwipe': 'スワイプ',
  'tabBarSwipeMode': 'タブバーのスワイプ',
  'tabBarSwipePages': 'タブのページ',
  'tabBarSwipeSpaces': 'スペース',
  'tabBarSwipePagesHint': 'タブバーをスワイプしてタブのページを切り替えます。',
  'tabBarSwipeSpacesHint': 'タブバーをスワイプしてスペースを切り替えます。タブは最初のページのみ表示されます。',
  'notesMarkdownAlwaysHint': 'メモは Markdown で書きます。CommonMark に GitHub 拡張（表・タスクリスト・脚注）と、\$ … \$ や \$\$ … \$\$ の LaTeX が使えます。',
  'accounts': '口座',
  'account': '口座',
  'allAccounts': 'すべて',
  'noAccount': '口座なし',
  ...
  'accountTypeCard': 'カード',
  'accountTypeBank': '銀行',
  'accountTypeSavings': '貯蓄',
  'accountTypeOther': 'その他',
  'accountInitialBalance': '開始残高',
  'accountInitialBalanceHint': '記録を始める前に口座にあった金額。',
  'accountArchive': 'アーカイブ',
  'accountUnarchive': 'アーカイブ解除',
  'accountArchived': 'アーカイブ済み',
  'showArchivedAccounts': 'アーカイブを表示',
  'accountsTotal': '合計',
  'noAccountsYet': '口座がありません',
  'deleteAccountTitle': '口座を削除しますか？',
  'deleteAccountBody': '記録は残りますが、口座の紐付けは外れます。',
  'manage': '管理',
  'transfer': '振替',
  'transferFrom': '振替元',
  'transferTo': '振替先',
  'transferPickAccount': '口座を選ぶ',
  'transferReceivedAmount': '受取額',
  'budgetsCurrencyHint': '予算は {currency} の記録のみ集計します。アプリは通貨を換算しません。',
  // ── Finance ──────────────────────────────────────────────────────────
  'tabFinance': 'ファイナンス',
  'more': 'その他',
  'transactions': '取引',
  'newTransaction': '新規記録',
  'editTransaction': '記録を編集',
  'transactionTitle': '内容',
  'expense': '支出',
  'expenses': '支出',
  'income': '収入',
  ...
  'categoryName': 'カテゴリ名',
  'noCategoriesYet': 'カテゴリがありません',
  'deleteCategoryTitle': 'カテゴリを削除しますか？',
  'deleteCategoryBody': '記録は残りますが、カテゴリなしになります。',
  'deleteTransactionTitle': '記録を削除しますか？',
  'deleteTransactionBody': 'この記録は完全に削除されます。',
  'transactionDeleted': '記録を削除しました',
  'noTransactionsThisMonth': '今月の記録はありません',
  'tapPlusToAddTransaction': '+ をタップして支出または収入を追加',
  'spendingByCategory': 'カテゴリ別の支出',
  'budgets': '予算',
  'budgetsHint': '支出全体または個別のカテゴリに上限を設定します。進捗は「ファイナンス」タブに表示されます。',
  'budgetAmountHint': '金額を入力するか、クリアして予算を削除します。',
  'budgetPeriod': '予算の期間',
  'monthly': '毎月',
  'weekly': '毎週',
  'noBudget': 'なし',
  'overallBudget': '全体の予算',
  'weeklyBudget': '週間予算',
  'leftToSpend': '残り {amount}',
  'overBudgetBy': '{amount} 超過',
  'sectionCurrency': '通貨',
  'currency': '通貨記号',
  'customCurrency': 'カスタム…',
  'showDecimals': '小数を表示',
  'showDecimalsHint': '小数を使わない通貨ではオフにします。',
  'colorLabel': 'カラー',
  'iconLabel': 'アイコン',
  ...
  'specificWeek': '週', 'specificMonth': '月', 'routineMonthDaysPrefix': '日',
  'continueAfterCompletion': '完了後も記録を続ける',
  'continueAfterCompletionInfo': '目標を達成した後も進捗を記録し続けます',
