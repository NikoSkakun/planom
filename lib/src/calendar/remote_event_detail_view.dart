...
/// `events` table.
class RemoteEventDetailView extends StatefulWidget {
  const RemoteEventDetailView({
    super.key,
    required this.event,
  ...
  @override
  State<RemoteEventDetailView> createState() => _RemoteEventDetailViewState();
}

class _RemoteEventDetailViewState extends State<RemoteEventDetailView> {
  ...
  Future<void> _openInGoogle() async {
    final link = widget.event.htmlLink;
  ...
  Future<void> _delete() async {
    ...
    final confirmed = await showCupertinoDialog<bool>(
      ...
      builder: (ctx) => CupertinoAlertDialog(
        ...
        content: Text(s.googleCalendarDeleteBody),
        actions: [
        ...
        child: ListView(
          ...
          children: [
            _SourceChip(
              ...
              text: '${s.googleCalendar} · ${ev.calendarName}'
                  '${readOnly ? ' · ${s.googleCalendarReadOnly}' : ''}',
            ),
